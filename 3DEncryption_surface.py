...
def plot_surface(
    ...
    # Pastel colormaps for better visibility
    if color_by == 'diffusion':
        ...
        )  # lavender → periwinkle → deep violet
        ...
        )  # soft yellow → lavender → rich purple
    ...
    # Wireframe overlays with black edges
    ax.plot_wireframe(x, y, z, color='black', linewidth=0.5, rstride=5, cstride=5, alpha=0.7)

    # Contour projection on XY plane for reference
